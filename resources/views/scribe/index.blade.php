...
<head>
    ...
    <title>simple-rest-api API Documentation</title>
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="users">
                    <a href="#users">Users</a>
                                ...
                                <a href="#users-GETapi-v1-users--user_id-">Show user</a>
                            </li>
                                ...
                                <a href="#users-PUTapi-v1-users--user_id-">Update user</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="users-DELETEapi-v1-users--user_id-">
                                <a href="#users-DELETEapi-v1-users--user_id-">Delete user</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>Example: <code>strongpassword123</code></p>
    ...
    <p>Endpoints related to user management.</p>
...
<p>Get a paginated list of users.</p>
...
<div class="bash-example">
    ...
    --get "http://localhost/api/v1/users?per_page=10&amp;filter%5Bname%5D=John+Doe&amp;filter%5Bemail%5D=john%40example.com&amp;sort=name" \
...
<span id="example-responses-GETapi-v1-users">
            <blockquote>
            <p>Example response (200, Successful response with paginated users.):</p>
        </blockquote>
                <pre>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
    ...
    <br>
<p>Number of users per page (1–100). Example: <code>10</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="query">
    <br>
<p>Filter users by exact name. Example: <code>John Doe</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="query">
    <br>
<p>Filter users by exact email. Example: <code>john@example.com</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="query">
    <br>
<p>Sort by name (e.g. &quot;sort=name&quot; or &quot;sort=-name&quot;). Example: <code>name</code></p>
            </div>
                </form>

                    <h2 id="users-GETapi-v1-users--user_id-">Show user</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Retrieve a single user by ID. Returns detailed user information.</p>
...
<span id="example-responses-GETapi-v1-users--user_id-">
            <blockquote>
            <p>Example response (200, User retrieved successfully.):</p>
        </blockquote>
                <pre>
...
<p>Creates a new user and returns the created resource. Requires authentication.</p>
...
<span id="example-responses-POSTapi-v1-users">
            <blockquote>
            <p>Example response (201, User created successfully.):</p>
        </blockquote>
                <pre>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The user's full name. Example: <code>Alice Example</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>email</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The user's email address. Example: <code>alice@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The user's password. Example: <code>P@ssw0rd!23</code></p>
        </div>
        </form>

                    <h2 id="users-PUTapi-v1-users--user_id-">Update user</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Updates an existing user and returns the updated resource.</p>
...
<span id="example-responses-PUTapi-v1-users--user_id-">
            <blockquote>
            <p>Example response (200, User updated successfully.):</p>
        </blockquote>
                <pre>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The user's full name. Example: <code>Alice Updated</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>email</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The user's email address. Example: <code>alice.updated@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The user's new password. Example: <code>N3wP@ssw0rd!</code></p>
        </div>
        </form>

                    <h2 id="users-DELETEapi-v1-users--user_id-">Delete user</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Deletes an existing user by ID. Requires authentication.</p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="DELETEapi-v1-users--user_id-"
               value="1"
               data-component="url">
    <br>
